    ...
    <div className="container mx-auto px-6 py-24 relative z-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative p-8 rounded-3xl border border-black/10 bg-white shadow-xl">
            {/* Dashboard Header */}
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-xs text-black/60">AI Agent Dashboard</div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  <div key={index} className="p-3 rounded-xl bg-black/5 border border-black/10">
              ...
              <div className="p-4 rounded-xl bg-black/5 border border-black/10">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm font-medium text-black">Live Agent Activity</span>
                </div>
                <div className="space-y-2">
                  {[
                    ...
                    <div key={index} className="flex items-center justify-between py-2">
                      <div>
                        <div className="text-sm text-black">{activity.agent}</div>
                        <div className="text-xs text-black/60">{activity.task}</div>
                      </div>
                      <div
              ...
              <div className="p-4 rounded-xl bg-black/5 border border-black/10">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm font-medium text-black">Performance Metrics</span>
                </div>
            ...
            <div className="absolute -bottom-4 -left-4 p-3 rounded-full bg-black animate-pulse delay-1000">
        ...
        >
          {/* Section Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full bg-black/5">
            <div className="w-1.5 h-1.5 rounded-full bg-gold" />
            <span className="text-xs font-medium text-black/70">Why Choose Us</span>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="group">
                <h3 className="text-2xl font-light text-black mb-3 group-hover:text-gold transition-colors duration-300">
