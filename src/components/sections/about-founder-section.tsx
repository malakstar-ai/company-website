        ...
        >
          ...
          <div className="relative p-8 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm">
            ...
            <div className="text-center mb-8">
              ...
              <h3 className="text-3xl font-light text-white mb-2">Malak Star AI</h3>
              <p className="text-white/40 italic text-sm">Built by a Founder Who Automates Everything — Including This Agency</p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white/10">
              <div className="text-center">
                ...
                <div className="text-xs text-white/60">Hours Saved Per Client</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-gold mb-1">150+</div>
                <div className="text-xs text-white/60">AI Tools Tested</div>
              </div>
            </div>
          </div>
        </div>
