    ...
    <div className="container mx-auto px-6 py-24 relative z-10">
      ...
      <div className="text-center mb-16">
        <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full bg-black/5">
          ...
          <span className="text-xs font-medium text-black/70">Ready to Transform</span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
        ...
        >
          <div className="p-8 rounded-3xl border border-black/10 bg-white shadow-xl">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2 rounded-xl bg-gold/10">
                <Calendar className="w-5 h-5 text-gold" />
              </div>
              <h3 className="text-2xl font-light text-black">Book a Strategy Call</h3>
            </div>

            {/* Date Selection */}
            <div className="mb-6">
              <h4 className="text-lg font-medium text-black mb-4">Select a Date</h4>
                    ...
                    className={`p-3 rounded-xl text-center transition-all duration-300 ${
                      selectedDate === dateOption.date
                        ...
                        : dateOption.available
                          ...
                          : "bg-black/5 border border-black/5 text-black/30 cursor-not-allowed"
                    }`}
                  >
            ...
            {selectedDate && (
              <div className="mb-6">
                <h4 className="text-lg font-medium text-black mb-4">Select a Time</h4>
        ...
        >
          <div className="p-8 rounded-3xl border border-black/10 bg-white shadow-xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-light text-black">Tell Us About Your Business</h3>
            </div>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Input
                  ...
                  className="bg-black/5 border-black/10 text-black placeholder:text-black/40 focus:border-gold focus:ring-gold"
                />
                <Input
              ...
              <Textarea
                ...
                rows={4}
                className="bg-black/5 border-black/10 text-black placeholder:text-black/40 focus:border-gold focus:ring-gold resize-none"
              />

              <Button
                type="submit"
                size="lg"
                className="w-full group px-6 py-6 text-sm font-medium bg-black hover:bg-black/90 text-white rounded-full transition-all duration-300 hover:shadow-lg"
              >
                Send Information
                <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
              </Button>
            ...
            <div className="mt-8 pt-6 border-t border-black/10">
              <h4 className="text-lg font-medium text-black mb-4">Prefer to reach out directly?</h4>
      ...
      >
        <div className="inline-flex items-center gap-6 px-8 py-4 rounded-2xl border border-black/10 bg-black/5">
          <div className="flex items-center gap-2">
            <CheckCircle className="w-5 h-5 text-[#10B981]" />
            <span className="text-black/80">Confidential</span>
          </div>
          <div className="w-px h-6 bg-black/20" />
          <div className="flex items-center gap-2">
            <CheckCircle className="w-5 h-5 text-[#10B981]" />
            <span className="text-black/80">No Commitment</span>
          </div>
          <div className="w-px h-6 bg-black/20" />
          <div className="flex items-center gap-2">
            <CheckCircle className="w-5 h-5 text-[#10B981]" />
            <span className="text-black/80">45 Minutes</span>
          </div>
        </div>
      </div>
    </div>
