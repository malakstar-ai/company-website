...
export function MinimalBackground({ variant = "dark" }: MinimalBackgroundProps) {
  ...
  useEffect(() => {
    ...
    const dotColor = isDark ? "rgba(255, 255, 255, 0.15)" : "rgba(0, 0, 0, 0.05)"
    const lineColor = isDark ? "rgba(255, 255, 255, 0.03)" : "rgba(0, 0, 0, 0.02)"
    const accentColor = isDark ? "rgba(212, 175, 55, 0.1)" : "rgba(212, 175, 55, 0.05)"
